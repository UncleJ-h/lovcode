...
import { LazyAnnualReport2025 } from '../views/LazyViews';
...
export function AppRouter({
  ...
  // Annual Report (lazy-loaded)
  if (view.type === 'annual-report-2025') {
    return <LazyAnnualReport2025 onClose={() => navigate({ type: 'home' })} />;
  }
  ...
  if (
    ...
    return (
      <FeaturesLayout currentFeature={currentFeature} onFeatureClick={handleFeatureClick}>
        ...
        {view.type === 'skill-detail' && (
          <SkillDetailView skill={view.skill} onBack={() => navigate({ type: 'skills' })} />
        )}
        {view.type === 'hooks' && (
          <HooksView
        ...
        {view.type === 'sub-agent-detail' && (
          <SubAgentDetailView agent={view.agent} onBack={() => navigate({ type: 'sub-agents' })} />
        )}
