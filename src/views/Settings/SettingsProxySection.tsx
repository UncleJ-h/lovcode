/**
 * [INPUT]: 依赖 @tauri-apps/api/core invoke, UI components, hooks/useSettingsState, components/config MarketplaceItem
 * [OUTPUT]: 对外提供 SettingsProxySection 组件
 * [POS]: Settings 的代理预设管理子组件
...
import type { MarketplaceItem } from "../../components/config";
...
interface SettingsProxySectionProps {
  ...
  applyStatus: Record<string, "idle" | "loading" | "success" | "error">;
  setApplyStatus: (value: Record<string, "idle" | "loading" | "success" | "error"> | ((prev: Record<string, "idle" | "loading" | "success" | "error">) => Record<string, "idle" | "loading" | "success" | "error">)) => void;
  applyError: string | null;
  setApplyError: (value: string | null) => void;
  applyHint: Record<string, string>;
  setApplyHint: (value: Record<string, string> | ((prev: Record<string, string>) => Record<string, string>)) => void;
  testStatus: Record<string, "idle" | "loading" | "success" | "error">;
  setTestStatus: (value: Record<string, "idle" | "loading" | "success" | "error"> | ((prev: Record<string, "idle" | "loading" | "success" | "error">) => Record<string, "idle" | "loading" | "success" | "error">)) => void;
  testMessage: Record<string, string>;
  setTestMessage: (value: Record<string, string> | ((prev: Record<string, string>) => Record<string, string>)) => void;
  testMissingKeys: Record<string, string[]>;
  setTestMissingKeys: (value: Record<string, string[]> | ((prev: Record<string, string[]>) => Record<string, string[]>)) => void;
  testMissingValues: Record<string, Record<string, string>>;
  setTestMissingValues: (value: Record<string, Record<string, string>> | ((prev: Record<string, Record<string, string>>) => Record<string, Record<string, string>>)) => void;
  expandedPresetKey: string | null;
  setExpandedPresetKey: (value: string | null | ((prev: string | null) => string | null)) => void;
  selectedModels: Record<string, string>;
  setSelectedModels: (value: Record<string, string> | ((prev: Record<string, string>) => Record<string, string>)) => void;
  refreshSettings: () => void;
  getRawEnvFromSettings: (value: ClaudeSettings | null | undefined) => Record<string, string>;
}
...
export function SettingsProxySection({
  ...
  const handleTogglePresetPreview = (presetKey: string) => {
    setExpandedPresetKey((prev: string | null) => (prev === presetKey ? null : presetKey));
  };
  ...
  const [analyticsEnabledState, setAnalyticsEnabledState] = useState(isAnalyticsEnabled);
